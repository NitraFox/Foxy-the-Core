...
ENT.Base 		= "base_core3"
ENT.PrintName		= "Foxy the Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Dir			= "foxy" -- The name of your sub-folder, must be 4 characters.
/*---------------------------------------------------------
